...
.method public static createNotificationInfo(Landroid/content/Context;Landroid/content/Context;Lcom/google/firebase/messaging/NotificationParams;Ljava/lang/String;Landroid/os/Bundle;)Lcom/google/firebase/messaging/CommonNotificationBuilder$DisplayNotificationInfo;
    ...
    invoke-direct {v3, p1, p3}, Ld7/e0$n;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 15
    invoke-virtual {v3, p3}, Ld7/e0$n;->N(Ljava/lang/CharSequence;)Ld7/e0$n;
    ...
    invoke-virtual {v4, p3}, Ld7/e0$l;->A(Ljava/lang/CharSequence;)Ld7/e0$l;

    move-result-object p3

    invoke-virtual {v3, p3}, Ld7/e0$n;->z0(Ld7/e0$y;)Ld7/e0$n;
    ...
    .line 20
    invoke-virtual {v3, p3}, Ld7/e0$n;->t0(I)Ld7/e0$n;
    ...
    .line 22
    invoke-virtual {v3, p3}, Ld7/e0$n;->x0(Landroid/net/Uri;)Ld7/e0$n;
    ...
    .line 24
    invoke-virtual {v3, p3}, Ld7/e0$n;->M(Landroid/app/PendingIntent;)Ld7/e0$n;
    ...
    .line 26
    invoke-virtual {v3, p0}, Ld7/e0$n;->T(Landroid/app/PendingIntent;)Ld7/e0$n;
    ...
    invoke-virtual {v3, p0}, Ld7/e0$n;->I(I)Ld7/e0$n;
    ...
    .line 31
    invoke-virtual {v3, p0}, Ld7/e0$n;->C(Z)Ld7/e0$n;
    ...
    .line 33
    invoke-virtual {v3, p0}, Ld7/e0$n;->e0(Z)Ld7/e0$n;
    ...
    .line 35
    invoke-virtual {v3, p0}, Ld7/e0$n;->B0(Ljava/lang/CharSequence;)Ld7/e0$n;
    ...
    invoke-virtual {v3, p0}, Ld7/e0$n;->k0(I)Ld7/e0$n;
    ...
    invoke-virtual {v3, p0}, Ld7/e0$n;->G0(I)Ld7/e0$n;
    ...
    invoke-virtual {v3, p0}, Ld7/e0$n;->h0(I)Ld7/e0$n;
    ...
    .line 43
    invoke-virtual {v3, p1}, Ld7/e0$n;->r0(Z)Ld7/e0$n;
    ...
    invoke-virtual {v3, p3, p4}, Ld7/e0$n;->H0(J)Ld7/e0$n;
    ...
    .line 46
    invoke-virtual {v3, p0}, Ld7/e0$n;->F0([J)Ld7/e0$n;
    ...
    invoke-virtual {v3, p4, p1, p0}, Ld7/e0$n;->d0(III)Ld7/e0$n;
    ...
    invoke-virtual {v3, p0}, Ld7/e0$n;->S(I)Ld7/e0$n;
    ...
    invoke-direct {p0, v3, p1, p3}, Lcom/google/firebase/messaging/CommonNotificationBuilder$DisplayNotificationInfo;-><init>(Ld7/e0$n;Ljava/lang/String;I)V
...
.method private static getColor(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/Integer;
    ...
    .line 52
    :try_start_1
    invoke-static {p0, p1}, Lf7/d;->getColor(Landroid/content/Context;I)I
...
.method public static getOrCreateChannel(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Ljava/lang/String;
    ...
    .line 42
    .line 43
    invoke-static {v0, p1}, Lf0/e;->a(Landroid/app/NotificationManager;Ljava/lang/String;)Landroid/app/NotificationChannel;
    ...
    .line 144
    invoke-static {p1, p0, p2}, Lf0/i;->a(Ljava/lang/String;Ljava/lang/CharSequence;I)Landroid/app/NotificationChannel;
    ...
    .line 148
    invoke-static {v0, p0}, Lf0/g;->a(Landroid/app/NotificationManager;Landroid/app/NotificationChannel;)V
