...
.method public constructor <init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    .line 3
    .line 4
    invoke-static {p1}, Lnk/p;->a(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;
    ...
    .line 8
    iput-object p1, p0, Lnk/i;->a:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public c(Ljava/lang/Runnable;)Lxj/c;
    ...
    .line 4
    invoke-virtual {p0, p1, v0, v1, v2}, Lnk/i;->d(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lxj/c;
...
.method public dispose()V
    ...
    .line 6
    iput-boolean v0, p0, Lnk/i;->b:Z

    .line 7
    .line 8
    iget-object v0, p0, Lnk/i;->a:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public f(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;Lbk/c;)Lnk/n;
    .locals 3
    .param p4    # Ljava/util/concurrent/TimeUnit;
        .annotation build Lwj/f;
        .end annotation
    ...
    .line 6
    .line 7
    invoke-direct {v0, p1, p5}, Lnk/n;-><init>(Ljava/lang/Runnable;Lbk/c;)V
    ...
    .line 11
    .line 12
    invoke-interface {p5, v0}, Lbk/c;->a(Lxj/c;)Z
    ...
    .line 25
    :try_start_0
    iget-object p1, p0, Lnk/i;->a:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    .line 45
    .line 46
    invoke-interface {p5, v0}, Lbk/c;->c(Lxj/c;)Z
...
.method public h(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lxj/c;
    ...
    .line 10
    .line 11
    new-instance p4, Lnk/f;

    .line 12
    .line 13
    iget-object p5, p0, Lnk/i;->a:Ljava/util/concurrent/ScheduledExecutorService;

    .line 14
    .line 15
    invoke-direct {p4, p1, p5}, Lnk/f;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ExecutorService;)V
    ...
    .line 37
    :goto_0
    invoke-virtual {p4, p1}, Lnk/f;->c(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
