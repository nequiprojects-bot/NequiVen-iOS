...
# static fields
.field public static final a:Ljava/lang/String; = "android.support.v4.media.session.IMediaControllerCallback"
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 33
    invoke-interface {p0, p1}, Landroid/support/v4/media/session/a;->X(I)V
    ...
    .line 47
    :cond_0
    invoke-interface {p0, v0}, Landroid/support/v4/media/session/a;->u0(Z)V
    ...
    .line 61
    :cond_1
    invoke-interface {p0, v0}, Landroid/support/v4/media/session/a;->x0(Z)V
    ...
    .line 72
    invoke-interface {p0, p1}, Landroid/support/v4/media/session/a;->C0(I)V
    ...
    .line 94
    :cond_2
    invoke-interface {p0, v3}, Landroid/support/v4/media/session/a;->f0(Landroid/support/v4/media/session/ParcelableVolumeInfo;)V
    ...
    .line 138
    :cond_4
    invoke-interface {p0, v3}, Landroid/support/v4/media/session/a;->q(Ljava/lang/CharSequence;)V
    ...
    .line 151
    invoke-interface {p0, p1}, Landroid/support/v4/media/session/a;->b(Ljava/util/List;)V
    ...
    .line 173
    :cond_5
    invoke-interface {p0, v3}, Landroid/support/v4/media/session/a;->S(Landroid/support/v4/media/MediaMetadataCompat;)V
    ...
    .line 195
    :cond_6
    invoke-interface {p0, v3}, Landroid/support/v4/media/session/a;->N0(Landroid/support/v4/media/session/PlaybackStateCompat;)V
