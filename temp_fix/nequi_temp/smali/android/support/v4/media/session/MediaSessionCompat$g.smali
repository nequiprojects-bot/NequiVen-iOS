...
.method public d(Landroid/support/v4/media/session/MediaSessionCompat$d;Landroid/os/Handler;)V
    ...
    .line 1
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$f;->d(Landroid/support/v4/media/session/MediaSessionCompat$d;Landroid/os/Handler;)V
    ...
    .line 13
    :cond_0
    new-instance p1, Landroid/support/v4/media/session/MediaSessionCompat$g$a;

    .line 14
    .line 15
    invoke-direct {p1, p0}, Landroid/support/v4/media/session/MediaSessionCompat$g$a;-><init>(Landroid/support/v4/media/session/MediaSessionCompat$g;)V
...
.method public y(Landroid/os/Bundle;)Landroid/media/RemoteControlClient$MetadataEditor;
    ...
    .line 1
    invoke-super {p0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$j;->y(Landroid/os/Bundle;)Landroid/media/RemoteControlClient$MetadataEditor;
