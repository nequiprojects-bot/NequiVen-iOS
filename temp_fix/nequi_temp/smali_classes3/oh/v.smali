...
.method static constructor <clinit>()V
    ...
    .line 5
    .line 6
    sput-object v0, Loh/v;->e:Landroid/graphics/RectF;
...
.method public static b(Lgh/o;Landroid/graphics/RectF;)Lgh/o;
    ...
    .line 2
    .line 3
    invoke-direct {v0, p1}, Loh/v$a;-><init>(Landroid/graphics/RectF;)V
...
.method public static f(Landroid/view/View;I)Landroid/view/View;
    ...
    .line 8
    :cond_0
    invoke-static {p0, p1}, Loh/v;->e(Landroid/view/View;I)Landroid/view/View;
...
.method public static l(FFFFF)F
    ...
    .line 7
    invoke-static/range {v0 .. v5}, Loh/v;->m(FFFFFZ)F
...
.method public static m(FFFFFZ)F
    ...
    .line 14
    :cond_0
    invoke-static {p0, p1, p4}, Loh/v;->k(FFF)F
...
.method public static o(Lgh/o;Lgh/o;Landroid/graphics/RectF;Landroid/graphics/RectF;FFF)Lgh/o;
    ...
    .line 19
    invoke-direct/range {v1 .. v6}, Loh/v$b;-><init>(Landroid/graphics/RectF;Landroid/graphics/RectF;FFF)V

    .line 20
    .line 21
    .line 22
    invoke-static {p0, p1, p2, v0}, Loh/v;->x(Lgh/o;Lgh/o;Landroid/graphics/RectF;Loh/v$d;)Lgh/o;
...
.method public static p(Landroid/transition/TransitionSet;Landroid/transition/Transition;)V
    .locals 0
...
.method public static s(Landroid/transition/Transition;Landroid/content/Context;I)Z
    ...
    .line 2
    .line 3
    invoke-static {p1, p2}, Loh/v;->u(Landroid/content/Context;I)Landroid/transition/PathMotion;
...
.method public static t(Landroid/transition/TransitionSet;Landroid/transition/Transition;)V
    .locals 0
    .param p1    # Landroid/transition/Transition;
        .annotation build Ll/q0;
        .end annotation
...
.method public static u(Landroid/content/Context;I)Landroid/transition/PathMotion;
    .locals 3
    .param p1    # I
        .annotation build Ll/f;
        .end annotation
    ...
    .line 30
    .line 31
    new-instance p0, Loh/k;

    .line 32
    .line 33
    invoke-direct {p0}, Loh/k;-><init>()V
...
.method public static v(Landroid/graphics/Canvas;Landroid/graphics/Rect;I)I
    ...
    .line 1
    sget-object v0, Loh/v;->e:Landroid/graphics/RectF;
...
.method public static w(Landroid/graphics/Canvas;Landroid/graphics/Rect;FFFILoh/v$c;)V
    .locals 1
    ...
    .line 17
    .line 18
    invoke-static {p0, p1, p5}, Loh/v;->v(Landroid/graphics/Canvas;Landroid/graphics/Rect;I)I

    .line 19
    .line 20
    .line 21
    :cond_1
    invoke-interface {p6, p0}, Loh/v$c;->a(Landroid/graphics/Canvas;)V
...
.method public static x(Lgh/o;Lgh/o;Landroid/graphics/RectF;Loh/v$d;)Lgh/o;
    .locals 2

    .line 1
    invoke-static {p0, p2}, Loh/v;->j(Lgh/o;Landroid/graphics/RectF;)Z
    ...
    .line 22
    invoke-interface {p3, v0, v1}, Loh/v$d;->a(Lgh/d;Lgh/d;)Lgh/d;
    ...
    .line 70
    invoke-interface {p3, p0, p1}, Loh/v$d;->a(Lgh/d;Lgh/d;)Lgh/d;
